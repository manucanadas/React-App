        ...
        <div className='cards'>
            ...
            <div className="cards__container">
                <div className="cards__wrapper">
                    ...
                    <ul className='cards__items'>
                       <CardItem src='images/img-3.jpg' text='Set Sali in the Atlantic Ocean visiting Uncharted Waters' label='Mystery' path='/services' /> 
                       <CardItem src='images/img-4.jpg' text='Experience Football on Top of the Himalayan Montains' label='Aventure' path='/products' /> 
